...
import PremierePlayerWrapper from "../../../components/premiere-player-wrapper";
      ...
      <main className="mx-auto max-w-6xl space-y-10 px-4 pb-20 pt-10 sm:px-6">
        <section className="grid gap-4 sm:rounded-3xl sm:border sm:border-white/10 sm:bg-[rgba(255,255,255,0.02)] sm:p-6 lg:grid-cols-[1.6fr_0.8fr]">
          ...
          <div className="space-y-6">
            {/* Player */}
            {/* Player */}
            <PremierePlayerWrapper
              movieId={detail.movie_id}
              episodeId={detail.id}
              videoUrl={detail.video_url}
              thumbnailUrl={detail.thumbnail_url}
              moviePoster={detail.movie_poster}
              liveStartAt={detail.live_start_at}
              isPremiere={Boolean(detail.is_premiere)}
            />
